...
type IFavoriteController interface {
	...
	GetUserAllFvorites(c echo.Context) error
}
...
func (fc *favoriteContoroller) GetUserAllFvorites(c echo.Context) error {
	...
	favoriteArticles, err := fc.fu.GetAllFavoriteArticles(userId)
	if err != nil {
		return c.JSON(http.StatusInternalServerError, err.Error())
	}
	return c.JSON(http.StatusOK, favoriteArticles)
}
